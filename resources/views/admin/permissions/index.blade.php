    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                ...
                <a href="{{ route('admin.permissions.create') }}" class="inline-block bg-green-700 hover:bg-green-600 text-white font-semibold py-2 px-4 border border-transparent rounded-md shadow-sm transition duration-300 ease-in-out">Create Permission</a>
                </div>
